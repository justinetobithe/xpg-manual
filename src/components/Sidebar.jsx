...
export default function Sidebar({ games = [], selected = "All", onSelect = () => { } }) {
    ...
    return (
        <aside className="sticky top-[84px] self-start w-full lg:w-64 mb-5">
            <h3 className="text-1xl md:text-2xl uppercase tracking-wide text-gray-200 mb-5 font-extrabold">
                {t("list.games")} {total}
            </h3>
            <div
                ...
                <ul className="space-y-2">
                    <li>
                        <button
                            ...
                            className={`w-full text-left block px-5 py-4 rounded-lg border text-xl md:text-1xl font-extrabold ${selected === "All"
                        ...
                        .map((g) => (
                            <li key={g.tag}>
                                <button
                                    ...
                                    className={`w-full text-left block px-5 py-4 rounded-lg border text-xl md:text-1xl font-extrabold ${selected === g.tag
                                        ? "border-[#F4A52E] text-primary-300 bg-[#1a2028]"
                                        : "border-[#2a3444] text-gray-100 hover:text-primary-300 hover:border-[#A66C13]"
                                        }`}
                                >
